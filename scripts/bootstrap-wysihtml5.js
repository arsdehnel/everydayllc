!function($, wysi) {
	...
	var templates = {
		...
		"emphasis":     "<li>" +
							"<div class='btn-group'>" 
							    + "<a class='btn icon-bold' data-wysihtml5-command='bold' title='CTRL+B'></a>" 
							    + "<a class='btn icon-italic' data-wysihtml5-command='italic' title='CTRL+I'></a>" 
							    + "<a class='btn icon-underline' data-wysihtml5-command='underline' title='CTRL+U'></a>" 
							+ "</div>" 
						+ "</li>",
		"lists": 	"<li>" 
						+ "<div class='btn-group'>" 
